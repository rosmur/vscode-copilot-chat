...
export namespace ConfigKey {
	...
	*/
	...
	export const PiAgentEnabled = defineSetting<boolean>('chat.piAgent.enabled', ConfigType.Simple, false);
	export const PiAgentApiKey = defineSetting<string>('chat.piAgent.apiKey', ConfigType.Simple, '');
